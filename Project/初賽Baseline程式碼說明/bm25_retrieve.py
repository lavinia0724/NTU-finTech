...
# python bm25_retrieve.py --question_path ../dataset/preliminary/questions_example.json --source_path ../reference --output_path ../dataset/preliminary/pred_retrieve.json